...
user_table_insert = ("INSERT INTO users (user_id, first_name, last_name, gender, level) \
                        ...
                        (first_name, last_name, gender, level) = (EXCLUDED.user_id, EXCLUDED.first_name, EXCLUDED.last_name, EXCLUDED.level)")
...
song_select = ("SELECT s.song_id, s.artist_id FROM songs s \
                ...
                WHERE s.title = %s AND s.artist_id = %s AND s.duration = %s")
